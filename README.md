...
_Demonstrating the system's ability to detect faces in dark environments using CLAHE._
![Dark Environment Detection](screenshots/low_light_detection.png)

### 2. Student Registration Interface

_The React-based portal for enrolling new students._
![Registration Page](screenshots/registration_page.png)

### 3. Multi-Face Detection

_Simultaneous recognition of multiple students._
